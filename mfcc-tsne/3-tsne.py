...
def run_tsne(features_list):
    ...
    # Initialize t-SNE
    tsne = TSNE(n_components=2, learning_rate=500, perplexity=30, verbose=2, angle=0.1)
...
# Example usage
features_json_path = '/Users/siruiwang/Downloads/audioTSNE/features.json'
tsne_results_json_path = '/Users/siruiwang/Downloads/audioTSNE/tsne_results.json'
